...
public class DevicesLanguageGenerator extends FabricLanguageProvider {
    protected DevicesLanguageGenerator(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
        super(dataOutput, registryLookup);
    }

    protected DevicesLanguageGenerator(FabricDataOutput dataOutput, String languageCode, CompletableFuture<HolderLookup.Provider> registryLookup) {
...
//
//    public DevicesLanguageGenerator(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup, String languageCode) {
//        super(dataOutput, registryLookup);
//        this.languageCode = languageCode;
//    }
//
//    public DevicesLanguageGenerator(FabricDataOutput dataOutput, String languageCode, CompletableFuture<HolderLookup.Provider> registryLookup, String languageCode1) {
//        super(dataOutput, languageCode, registryLookup);
//        this.languageCode = languageCode1;
//    }
//
//    @Override
...
//    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
////        @NotNull
////        var pathode = getJSON(dataOutput.getModContainer().findPath("translations/" + translationBuilder. + ".json").orElseThrow());
////
