...
import dev.ultreon.devices.init.DeviceTags;
...
public class DevicesRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput recipeOutput) {
        DeviceBlocks.LAPTOPS.getMap().forEach(((dyeColor, blockRegistrySupplier) -> laptop(recipeOutput, blockRegistrySupplier.get(), dyeColor)));
