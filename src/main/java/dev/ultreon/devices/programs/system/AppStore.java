...
public class AppStore extends SystemApp {
    ...
    public void init(@Nullable CompoundTag intent) {
        ...
        dev.ultreon.devices.api.app.component.Image imageBanner = new dev.ultreon.devices.api.app.component.Image(0, 0, LAYOUT_WIDTH, 60);
        ...
        dev.ultreon.devices.api.app.component.Image image = new dev.ultreon.devices.api.app.component.Image(5, 33, 20, 20, Icons.SHOP);
