...
public abstract class DyeableRegistration<T> implements Iterable<RegistrySupplier<T>> {
    ...
    public static <T> void register(Registry<T> registrar, DyeableRegistration<T> dyeableRegistration) {
    ...
    public abstract RegistrySupplier<T> register(Registry<T> registrar, DyeColor color);

    public ImmutableMap<DyeColor, RegistrySupplier<T>> getMap() {
        return ImmutableMap.copyOf(map);
    }

    protected Registry<T> autoInit() {
        return null;
    }
