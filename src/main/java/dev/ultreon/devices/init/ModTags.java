...
public final class ModTags {
    public static final class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.create(Registries.ITEM, UltreonDevicesCommon.id(name));
        }
    }
    ...
    public static final class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.create(Registries.BLOCK, UltreonDevicesCommon.id(name));
        }
    }
    ...
    public static final class BlockEntityTypes {
        ...
        private static TagKey<BlockEntityType<?>> createTag(String name) {
            return TagKey.create(Registries.BLOCK_ENTITY_TYPE, UltreonDevicesCommon.id(name));
        }
    }
}
