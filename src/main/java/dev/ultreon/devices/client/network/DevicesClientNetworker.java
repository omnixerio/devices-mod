...
public class DevicesClientNetworker {
    public static void init() {
        ClientPlayNetworking.registerGlobalReceiver(ClientboundUpdatePacket.TYPE, (payload, _) -> {
        ...
        ClientPlayNetworking.registerGlobalReceiver(ClientboundResponsePacket.TYPE, (payload, context) -> {
