...
//        Services.PLATFORM.register(PackType.CLIENT_RESOURCES, OmnixerioDevicesCommon.id("reloader"), new ReloaderListener());
    }
...
//                        }
    ...
    public static void registerRenderers() {
        ...
        ClientServices.PLATFORM.registerEntityRenderer(DeviceEntities.SEAT, SeatEntityRenderer::new);

        ClientServices.PLATFORM.registerBlockEntityRenderer(DeviceBlockEntities.LAPTOP, LaptopRenderer::new);
        ClientServices.PLATFORM.registerBlockEntityRenderer(DeviceBlockEntities.PRINTER, PrinterRenderer::new);
        ClientServices.PLATFORM.registerBlockEntityRenderer(DeviceBlockEntities.PAPER, PaperRenderer::new);
        ClientServices.PLATFORM.registerBlockEntityRenderer(DeviceBlockEntities.ROUTER, RouterRenderer::new);
        ClientServices.PLATFORM.registerBlockEntityRenderer(DeviceBlockEntities.OFFICE_CHAIR, OfficeChairRenderer::new);
    }
