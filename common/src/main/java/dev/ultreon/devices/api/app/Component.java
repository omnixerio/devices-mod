...
public abstract class Component {
    ...
    public static final ResourceLocation COMPONENTS_GUI = ResourceLocation.parse("devices:textures/gui/components.png");
    ...
    /// sub-components through this method. Use [#addComponent(Component)]
    ///
