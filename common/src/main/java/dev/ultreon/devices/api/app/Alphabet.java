...
public enum Alphabet implements IIcon {
    ...
    private static final ResourceLocation ALPHABET_ASSET = ResourceLocation.parse("devices:textures/gui/alphabet.png");
    ...
    public void draw(GuiGraphics graphics, Minecraft mc, int x, int y, int color) {
