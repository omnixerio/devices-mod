...
//        Lighting.turnOff();
    ...
    /// method is called after {[#init(CompoundTag)] so you can update any
    ...
    /// [#isDirty()] returns true. You can mark your application as dirty
    ...
    public Path getApplicationFolderPath() {
        return Path.of(FileSystem.DIR_APPLICATION_DATA + "/" + Objects.requireNonNull(info).getFormattedId());
    }
