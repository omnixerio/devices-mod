...
/// A simple interface to handle processing responses by [Task].
...
public interface Callback<T> {
    ...
    /// as [#processResponse(NBTTagCompound)]'s
    /// tag does.
    ///
    /// @param t       the response object
    /// @param success if the [Task] performed it's intended action correctly.
