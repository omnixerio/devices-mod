...
//        RenderSystem.enableLighting();
    ...
    public static void drawRectWithTexture(Identifier location, GuiGraphicsExtractor graphics, double x, double y, float u, float v, int width, int height, float textureWidth, float textureHeight) {
     ...
     */
    public static void drawRectWithTexture(Identifier location, GuiGraphicsExtractor graphics, double x, double y, double z, float u, float v, int width, int height, float textureWidth, float textureHeight) {
    ...
    public static void drawRectWithTexture(Identifier location, GuiGraphicsExtractor graphics, double x, double y, float u, float v, int width, int height, float textureWidth, float textureHeight, int sourceWidth, int sourceHeight) {
